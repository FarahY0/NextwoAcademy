...
namespace Nextwo.Areas.Dashboard.Controllers
{
    ...
    public class MenusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MenuId,MenuTitle,MinuSubTitle,MenuUrl,CreationDate,IsDeleted,IsActive")] Menu menu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MenuId,MenuTitle,MinuSubTitle,MenuUrl,CreationDate,IsDeleted,IsActive")] Menu menu)
        {
            if (id != menu.MenuId)
            {
                return NotFound();
